...
import { geometryAnchor } from '../lib/geometryAnchor';
import { FEATURE_ICONS, type FeatureIconName } from '../../mapFeatures/lib/icons';
import { formatCoordinates } from '../../mapFeatures/lib/geometryMeasurements';
import { SANITIZE_CONFIG } from '../../mapFeatures/lib/sanitizeConfig';
