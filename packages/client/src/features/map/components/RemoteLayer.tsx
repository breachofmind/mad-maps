...
import { externalLayerDataQueryKey, fetchExternalLayerData } from '../../layers/lib/api';
import {
...
import { ensureExternalIconImages, externalIconImageId } from '../lib/externalIconImages';
